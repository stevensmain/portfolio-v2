/* empty css                           */import { c as createAstro, b as createComponent, r as renderTemplate, e as addAttribute, f as renderHead, g as renderComponent, h as renderSlot, m as maybeRenderHead } from '../astro.bf81388d.mjs';
import 'html-escaper';
import 'clsx';
...
const Menu = ({ navLinks }) => {
  ...
  return /* @__PURE__ */ React$1.createElement("nav", { className: "block md:hidden" }, /* @__PURE__ */ React$1.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React$1.createElement("div", { className: "ham-box" }, /* @__PURE__ */ React$1.createElement("div", { className: `ham-box-inner ${menuOpen ? "active" : ""}` }))
    ...
    /* @__PURE__ */ React$1.createElement("nav", { ref: navRef, className: "w-full flex flex-col text-slate-400 text-center" }, navLinks && /* @__PURE__ */ React$1.createElement("ol", { className: "p-0 m-0 list-none w-full" }, navLinks.map(({ url, name }, i) => /* @__PURE__ */ React$1.createElement("li", { key: i, className: "relative mt-0 mx-auto mb-6 text-xl" }, /* @__PURE__ */ React$1.createElement("a", { href: url, onClick: () => setMenuOpen(false) }, name)))), /* @__PURE__ */ React$1.createElement("a", { className: "text-slate-400 border-slate-400 border px-4 py-3 rounded duration-200 hover:bg-neutral-800", href: "/resume.pdf", target: "_blank", rel: "noopener noreferrer" }, "Resume"))
  ));
};
...
const Nav = () => {
  ...
  const ResumeLink = /* @__PURE__ */ React$1.createElement("a", { className: "text-slate-400 border-slate-400 border px-4 py-2 rounded duration-200 hover:text-emerald-300 hover:border-esmerald-300 hover:bg-slate-300/20", href: "/resume.pdf", target: "_blank", rel: "noopener noreferrer" }, "Resume");
  return /* @__PURE__ */ React$1.createElement("header", { className: `fixed top-0 py-4 w-full h-24 flex justify-between px-8 md:px-24 duration-200 ease-in items-center bg-navy z-10 backdrop-blur-md ${scrollDirection === "down" && "-translate-y-24"} ${!scrolledToTop && "shadow-xl"}` }, /* @__PURE__ */ React$1.createElement(
    "div",
    {
      className: "h-12 w-12",
      "data-aos": "fade",
    ...
    /* @__PURE__ */ React$1.createElement("a", { href: "/#hero", "aria-label": "home" }, /* @__PURE__ */ React$1.createElement(Logo, null))
  ), /* @__PURE__ */ React$1.createElement(Menu, { navLinks }), /* @__PURE__ */ React$1.createElement("nav", { className: "hidden md:inline-flex text-slate-400" }, /* @__PURE__ */ React$1.createElement("ol", { className: "flex items-center justify-between gap-8" }, navLinks.map(
    ({ url, name }, i) => /* @__PURE__ */ React$1.createElement(
      "li",
      {
        "data-aos": "fade-down",
        "data-aos-duration": "300",
      ...
      /* @__PURE__ */ React$1.createElement("a", { className: "pointer text-slate-400 hover:text-emerald-300", href: url }, `0${i + 1}. ${name}`)
    )
  ), /* @__PURE__ */ React$1.createElement(
    "li",
    {
...
const Text = ({ children }) => {
  return /* @__PURE__ */ React.createElement("p", { className: "text-base text-slate-400" }, children);
};
...
const Title = ({
  ...
  return /* @__PURE__ */ React.createElement("h2", { className: "text-2xl text-slate-400 font-base section-title" }, prevMark && prevMark, /* @__PURE__ */ React.createElement("strong", { className: "text-3xl text-slate-300 ml-3 font-bold md:whitespace-nowrap" }, children));
};
...
const External = ({ width = 24, height = 24 }) => {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M11 7h-5a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-5" }),
    /* @__PURE__ */ React.createElement("line", { x1: "10", y1: "14", x2: "20", y2: "4" }),
    /* @__PURE__ */ React.createElement("polyline", { points: "15 4 20 4 20 9" })
  );
};
...
const LinkedIn = ({ width = 30, height = 30 }) => {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("line", { x1: "8", y1: "11", x2: "8", y2: "16" }),
    /* @__PURE__ */ React.createElement("line", { x1: "8", y1: "8", x2: "8", y2: "8.01" }),
    /* @__PURE__ */ React.createElement("line", { x1: "12", y1: "16", x2: "12", y2: "11" }),
    /* @__PURE__ */ React.createElement("path", { d: "M16 16v-3a2 2 0 0 0 -4 0" })
  );
};
